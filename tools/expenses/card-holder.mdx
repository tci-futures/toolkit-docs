...
<iframe
	src='https://thomascarroll-my.sharepoint.com/personal/mike_rudge_tcifutures_co_uk/_layouts/15/embed.aspx?UniqueId=a569a951-f9ea-447e-88b7-3d48e4b1dd69&embed=%7B%22ust%22%3Atrue%2C%22hv%22%3A%22CopyEmbedCode%22%7D&referrer=StreamWebApp&referrerScenario=EmbedDialog.Create'
	width='100%'
	height='420'
	frameborder='0'
	scrolling='no'
	allowfullscreen
	title='how_to_match_receipts.mp4'
></iframe>
</Frame>
...
<Tip>
	Use our [Merge PDFs](https://tools.tcifutures.co.uk/admin/pdf-converter/merge)
	tool to quickly combine multiple receipt PDFs into a single file for the
	statement
</Tip>
...
- [Split the PDF](https://tools.tcifutures.co.uk/admin/pdf-converter/split) into separate pages and upload each relevant page as a separate file.
...
<Tip>
	Use our [Split PDFs](https://tools.tcifutures.co.uk/admin/pdf-converter/split)
	tool to divide multi-page receipts into individual files for each statement
	line.
</Tip>
