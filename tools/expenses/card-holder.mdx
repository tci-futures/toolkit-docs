...
<Warning>
	The AI can make mistakes. Always confirm the amount, date and merchant before
	you submit.
</Warning>
...
If you can’t find a matching receipt:

- Mark the line as unreconcilable. The app creates a new expense item for the amount.
- Add notes explaining why (for example: corporate charge, lost receipt).
- Match the statement line to the new expense item as normal.
